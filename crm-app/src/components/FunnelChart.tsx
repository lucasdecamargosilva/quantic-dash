...
const STAGES_AFTER: Record<LeadStatus, LeadStatus[]> = {
  ...
  lead_coletado: [],
  descartado: [],
  dm_enviada: ["mensagem_1", "mensagem_2", "mensagem_3", "email_enviado", "respondeu", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  mensagem_1: ["mensagem_2", "mensagem_3", "email_enviado", "respondeu", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  mensagem_2: ["mensagem_3", "email_enviado", "respondeu", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  mensagem_3: ["email_enviado", "respondeu", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  email_enviado: ["respondeu", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  respondeu: ["fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  fotos_enviadas: ["interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  interessado: ["stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  stand_by: ["reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  reuniao_agendada: ["testando", "fechou", "sem_site", "parou_responder", "perdida"],
  testando: ["fechou", "sem_site", "parou_responder", "perdida"],
  fechou: [],
  sem_site: [],
  parou_responder: [],
  perdida: [],
