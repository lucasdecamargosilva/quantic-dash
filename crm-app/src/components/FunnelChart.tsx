...
const STAGES_AFTER: Record<LeadStatus, LeadStatus[]> = {
  ...
  meta: [],
  email_a_enviar: [],
  dm_enviada: ["mensagem_1", "mensagem_2", "mensagem_3", "email_enviado", "respondeu", "atendimento_ia", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
  mensagem_1: ["mensagem_2", "mensagem_3", "email_enviado", "respondeu", "atendimento_ia", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
  mensagem_2: ["mensagem_3", "email_enviado", "respondeu", "atendimento_ia", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
  mensagem_3: ["email_enviado", "respondeu", "atendimento_ia", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
  email_enviado: ["respondeu", "atendimento_ia", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
  respondeu: ["atendimento_ia", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
  atendimento_ia: ["fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
  fotos_enviadas: ["interessado", "stand_by", "reuniao_agendada", "testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
  interessado: ["stand_by", "reuniao_agendada", "testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
  stand_by: ["reuniao_agendada", "testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
  reuniao_agendada: ["testando", "testou_e_saiu", "fechou", "sem_site", "parou_responder", "perdida"],
