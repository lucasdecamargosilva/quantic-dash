...
const STAGES_AFTER: Record<LeadStatus, LeadStatus[]> = {
  ...
  lead_coletado: [],
  descartado: [],
  dm_enviada: ["mensagem_1", "mensagem_2", "mensagem_3", "email_enviado", "respondeu", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "perdida"],
  mensagem_1: ["mensagem_2", "mensagem_3", "email_enviado", "respondeu", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "perdida"],
  mensagem_2: ["mensagem_3", "email_enviado", "respondeu", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "perdida"],
  mensagem_3: ["email_enviado", "respondeu", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "perdida"],
  email_enviado: ["respondeu", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "perdida"],
