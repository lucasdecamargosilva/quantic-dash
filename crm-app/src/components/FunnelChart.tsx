...
const STAGES_AFTER: Record<LeadStatus, LeadStatus[]> = {
  ...
  mensagem_3: ["email_enviado", "respondeu", "atendimento_ia", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  email_enviado: ["respondeu", "atendimento_ia", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  respondeu: ["atendimento_ia", "fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
  atendimento_ia: ["fotos_enviadas", "interessado", "stand_by", "reuniao_agendada", "testando", "fechou", "sem_site", "parou_responder", "perdida"],
